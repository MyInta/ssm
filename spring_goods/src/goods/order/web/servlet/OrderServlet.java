...
public class OrderServlet extends BaseServlet {
	...
	public String back(HttpServletRequest req, HttpServletResponse resp)
		...
		if(r1_Code.equals("1")) {
			...
			if(r9_BType.equals("1")) {
				...
				return "/jsps/msg.jsp";				
			} else if(r9_BType.equals("2")) {// 交易结果返回类型1浏览器重定向;2服务器点对点通讯.
	...
	public String confirm(HttpServletRequest req, HttpServletResponse resp)
		...
		//如果状态为3则可以进行取消,并将状态设置为4交易成功
		orderService.updateStatus(oid, 4);
		req.setAttribute("code", "success");
		req.setAttribute("msg", "您的订单已交易成功，欢迎再次选购！");
		return "/jsps/msg.jsp";
	}
	...
	public String createOrder(HttpServletRequest req, HttpServletResponse resp)
		...
		for(CartItem cartItem:cartItemList) {
			...
			orderItem.setSubtotal(cartItem.getSubtotal());//设置总计
